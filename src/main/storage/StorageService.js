...
class StorageService {
  constructor(customPath) {
    ...
    this.maxSessions = 100; // Default limit of sessions to keep
   ...
   */
  getSessionIds(startTime, endTime) {
    try {
